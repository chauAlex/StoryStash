...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference("Like.count") do
      post likes_url, params: { like: { articles_id: @like.articles_id, users_id: @like.users_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { articles_id: @like.articles_id, users_id: @like.users_id } }
